...
public abstract class ContextDataStructure {
	 ...
	 * u suprotnom
	 */
	public abstract Context searchKey(String key);
	 ...
	 */
	public abstract boolean insertKey(Context node);
	
	public abstract Collection<Context> contexts();
	
	public abstract int numContexts();
}
